        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="hidden lg:flex flex-col space-y-6 h-full justify-between">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-lg p-6 shadow-sm border border-fashion-beige/50 flex-1">
              ...
              <p className="text-sm text-fashion-teal/80 leading-relaxed">
                Cutting-edge data analytics transform traditional fashion retail into a personalized, data-driven experience.
              </p>
            </div>
          </div>
              ...
              {banners.map((_, index) => (
                <button 
                  ...
                  className={`w-3 h-3 rounded-full transition-all duration-300 ${
                    index === currentSlide ? 'scale-110 shadow-lg' : 'hover:opacity-70'
                  }`} 
                  style={{
